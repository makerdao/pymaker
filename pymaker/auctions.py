...
class AuctionContract(Contract):
    ...
    def beg(self) -> Ray:
        ...
        """
        return Ray(self._contract.caller.beg())
    ...
    def ttl(self) -> int:
        ...
        """
        return int(self._contract.caller.ttl())
    ...
    def tau(self) -> int:
        ...
        """
        return int(self._contract.caller.tau())
    ...
    def kicks(self) -> int:
        ...
        """
        return int(self._contract.caller.kicks())
...
class Flipper(AuctionContract):
    ...
    def bids(self, id: int) -> Bid:
        ...
        array = self._contract.caller.bids(id)
