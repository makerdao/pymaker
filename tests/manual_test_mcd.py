...
tends = mcd.collaterals['ETH-A'].flipper.past_dents(100000)
for tend in tends:
    # if tend.sig == "0x29ae8114":
    #     continue
    try:
        print(f"block={tend._raw['blockNumber']} sig={tend.sig} arg1={tend.arg1} arg2={tend.arg2} arg3={tend.arg3}")
    except ValueError as e:
        print(f"it's not sig={tend.sig} because {e}")
        pass
